...
namespace Electronica
{
    internal class Tablet : Device
    {
        ...
        public Tablet(string type, string brandAndModel, string screen, string processor, string ram, string storage, string mainCamera, string frontCamera, string battery, decimal price)
            : base(type, price)
        {
